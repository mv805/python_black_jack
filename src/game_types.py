...
class MenuData:
    ...
    Attributes:
        __title (str): The title of the menu.
        __options (Dict[int, str]): A dictionary of menu options, where the key is the option number and the value is the option text.
    """

    def __init__(self, title: str, menu_options: Dict[int, str]) -> None:
        """
        Initializes a new instance of the MenuData class.
